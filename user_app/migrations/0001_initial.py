    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disponibilities', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(choices=[('Lun', 'Lundi'), ('Mar', 'Mardi'), ('Mer', 'Mercredi'), ('Jeu', 'Jeudi'), ('Ven', 'Vendredi'), ('Sam', 'Samdi'), ('Dim', 'Dimanche')], max_length=25, verbose_name='day'), blank=True, default=list, null=True, size=None)),
